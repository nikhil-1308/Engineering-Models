...
% add constraints for collision avoiding
% obstacle avoiding is fr all the prediction steps
obs_x=0.5; % meters
obs_y=0.5; % meters
obs_diam=0.3; % mters
for k=1:N+1 % box constraints due to map margine
...
% inequality constraints for obstacle as they are added in the vector 'g'
