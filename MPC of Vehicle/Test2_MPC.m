...
addpath('C:\Users\NIKHIL\Desktop\Casadi based MPC\casadi-windows-matlabR2016a-v3.5.5')
import casadi.*
...
figure(1)
subplot(311)
plot(t,xx(1,1:end-1),'b','linewidth',3); axis([0 t(end) 0 1.8]);hold on
ylabel('x (m)')
grid on
subplot(312)
plot(t,xx(2,1:end-1),'b','linewidth',3); axis([0 t(end) 0 1.8]);hold on
ylabel('y (m)')
grid on
subplot(313)
plot(t,xx(3,1:end-1),'b','linewidth',3); axis([0 t(end) -pi/4 pi/2]);hold on
xlabel('time (seconds)')
ylabel('\theta (rad)')
grid on
...
figure(1)
subplot(311)
plot(t,xx(1,1:end-1),'--r','linewidth',2); axis([0 t(end) 0 1.8]);hold on
ylabel('x (m)')
legend('Ground Truth','Measurement','MHE','MPC')
grid on
subplot(312)
plot(t,xx(2,1:end-1),'--r','linewidth',2); axis([0 t(end) 0 1.8]);hold on
ylabel('y (m)')
grid on
subplot(313)
plot(t,xx(3,1:end-1),'--r','linewidth',2); axis([0 t(end) -pi/4 pi/2]);hold on
xlabel('time (seconds)')
ylabel('\theta (rad)')
grid on
m=1;
