...
% d_dot= a1+2*a2*t+3*a3*t^2+4*a4*t^3+5*a5*t^4;
% d_ddot= 2*a2+6*a3*t+12*a4*t^2+20*a5*t^3;
...
latPos= a0*1+a1*t+a2*t.^2+a3*t.^3+a4*t.^4+a5*t.^5;
latSpeed= a1*1+2*a2*t+3*a3*t.^2+4*a4*t.^3+5*a5*t.^4;
