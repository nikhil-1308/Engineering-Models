classdef LaneChanger < matlab.System & matlab.system.mixin.Propagates
    ...
    methods(Access = protected)
        ...
        function latSpeed = stepImpl(obj, flag, clock, y)
            ...
            if flag
                ...
                if (clock>10) && (isempty(obj.overtake))
                    obj.overtake= true;
                    obj.t_i = clock;
                 ...
                 if clock> obj.t_f
                     ...
                     %latPos= obj.a0*1+obj.a1*t+obj.a2*t.^2+obj.a3*t.^3+obj.a4*t.^4+a5*t.^5;
                     latSpeed= obj.a1*1+2*obj.a2*t+3*obj.a3*t.^2+4*obj.a4*t.^3+5*obj.a5*t.^4;
                     %latAcc= 2*obj.a2+6*obj.a3*t+12*obj.a4*t.^2+20*obj.a5*t.^3;
                 end
            else
               latSpeed=0; 
            end
